...
init() {
    echo "=========================================="
    echo "  AstraFlow Init — Pull Sandbox Image"
    echo "=========================================="
    echo ""
...
start() {
    ...
    echo "=========================================="
    echo "  Starting AstraFlow Docker Development"
    echo "=========================================="
    echo ""
    ...
    if [ ! -f "$PROJECT_ROOT/config.yaml" ]; then
        if [ -f "$PROJECT_ROOT/config.example.yaml" ]; then
            ...
            echo -e "${YELLOW}  configuration before starting AstraFlow.                  ${NC}"
            echo -e "${YELLOW}============================================================${NC}"
            echo ""
    ...
    echo ""
    echo "=========================================="
    echo "  AstraFlow Docker is starting!"
    echo "=========================================="
    echo ""
...
restart() {
    echo "========================================"
    echo "  Restarting AstraFlow Docker Services"
    echo "========================================"
    echo ""
...
# Show help
help() {
    echo "AstraFlow Docker Management Script"
    echo ""
