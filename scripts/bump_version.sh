...
#   deploy/helm/AstraFlow/Chart.yaml    (version: + appVersion:)
#
...
CHART="$ROOT/deploy/helm/AstraFlow/Chart.yaml"
...
# deploy/helm/AstraFlow/Chart.yaml — version: X.Y.Z and appVersion: "X.Y.Z"
...
echo "  deploy/helm/AstraFlow/Chart.yaml (version + appVersion)"
echo
