#!/usr/bin/env python3
"""Create a redacted AstraFlow support bundle for community troubleshooting."""
...
def render_issue_summary(triage: dict[str, Any]) -> str:
    ...
    lines = [
        "## AstraFlow support bundle summary",
        "",
...
def render_ai_issue_draft(triage: dict[str, Any], issue_summary: str, doctor: dict[str, Any] | None) -> str:
    ...
    lines = [
        "# AI issue draft",
        "",
        "Use this when a coding agent or AI assistant files a AstraFlow bug report.",
        ...
        "### Before you start",
        "",
        "- [ ] I searched [existing issues](https://github.com/Yukigithubycf/AstraFlow/issues?q=is%3Aissue) and this is not a duplicate.",
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--project-root", type=Path, default=repo_root, help="AstraFlow project root")
