#!/usr/bin/env python3
"""AstraFlow Interactive Setup Wizard.
...
def main() -> int:
    try:
        ...
        print()
        print(bold("Welcome to AstraFlow Setup!"))
        print("This wizard will help you configure AstraFlow in a few minutes.")
        print()
        ...
        print(f"  {cyan('make dev')}        # Start AstraFlow")
        print()
