#!/usr/bin/env bash
#
# serve.sh — Unified AstraFlow service launcher
#
# Usage:
...
# so pin AstraFlow-owned state to the expected backend runtime directory and
...
if ! { \
    ...
    echo "✗ No AstraFlow config file found."
...
echo ""
echo "=========================================="
echo "  ✓ AstraFlow is running!  [$MODE_LABEL]"
echo "=========================================="
echo ""
