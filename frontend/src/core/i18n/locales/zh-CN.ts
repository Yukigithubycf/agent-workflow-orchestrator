...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "今天要推进什么目标？",
    description: "AstraFlow 多智能体编排工作台已就绪。",

    createYourOwnSkill: "设计一个新技能",
    createYourOwnSkillDescription:
      "定义目标、输入与输出，让 AstraFlow 将它加入你的执行工具箱。",
  },
  ...
  // Input Box
  inputBox: {
    placeholder: "描述目标，AstraFlow 将开始编排…",
    ...
    voiceInputStart:
      "语音输入。AstraFlow 只接收转写文本，音频由浏览器或系统语音服务处理。",
    ...
    searchModels: "搜索模型...",
    surpriseMe: "自由探索",
    surpriseMePrompt: "选择一个值得探索的新方向，并给出可执行成果。",
    ...
    suggestions: [
      {
        suggestion: "方案设计",
        prompt: "为[主题]制定一套结构清晰、可执行的方案",
        icon: PenLineIcon,
      },
      {
        suggestion: "深度研究",
        prompt: "深入研究[主题]，验证关键事实并总结结论。",
        icon: MicroscopeIcon,
      },
      {
        suggestion: "数据洞察",
        prompt: "从[来源]收集数据、识别趋势并创建报告。",
        icon: ShapesIcon,
      },
      {
        suggestion: "知识梳理",
        prompt: "梳理[主题]的核心概念并生成学习路径。",
  ...
  taskExamples: {
    triggerLabel: "任务样例",
    title: "任务样例",
    description: "选择样例后会填入会话并切换至推荐模式，发送前仍可编辑。",
    onboardingTitle: "不知道从哪里开始？",
    onboardingDescription: "打开任务样例，快速体验已匹配推荐模式的请求。",
    onboardingAction: "查看任务样例",
    dismissOnboarding: "关闭任务样例提示",
    exampleLabel: "样例 {number}",
    useExample: "使用样例：{prompt}",
    worldModelsPrompt: "调研一下世界模型。",
    aiNewsPrompt: "帮我整理五条近一周的 AI 前沿资讯。",
    codingAgentsPrompt:
      "调研 OpenAI Codex、Claude Code 和 Gemini CLI，分别分析功能、价格和团队适用性，最后给出选型建议。",
  },
  ...
  agents: {
    ...
    saving: "正在保存智能体...",
    saveRequested:
      "已提交保存请求，AstraFlow 正在根据当前对话生成并保存初版智能体。",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但 AstraFlow 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  // Workspace
  workspace: {
    officialWebsite: "访问 AstraFlow 官方网站",
    githubTooltip: "访问 AstraFlow 的 GitHub 仓库",
    settingsAndMore: "设置和更多",
    visitGithub: "在 GitHub 上查看 AstraFlow",
    reportIssue: "报告问题",
    contactUs: "联系我们",
    about: "关于 AstraFlow",
    logout: "退出登录",
  ...
  channels: {
    ...
    saveChanges: "保存修改",
    descriptions: {
      telegram: "通过 AstraFlow Bot 接收 Telegram 私聊消息。",
      slack: "接收 Slack 工作区消息和提及。",
      discord: "通过 AstraFlow Bot 接收 Discord 服务器消息。",
      feishu: "通过 AstraFlow 应用接收飞书和 Lark 消息。",
      dingtalk: "通过 AstraFlow Bot 接收钉钉 Stream Push 消息。",
      wechat: "通过 AstraFlow Bot 接收微信 iLink 消息。",
      wecom: "通过 AstraFlow AI Bot 接收企业微信消息。",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 AstraFlow 中使用",
  ...
  subtasks: {
    ...
    galaxy: {
      leadAgent: "主 Agent",
      dispatching: "正在分派子任务",
      parallel: (count: number) => `${count} 个子 Agent 并行执行中`,
      converging: "正在汇聚子任务结果",
      completed: "子任务结果已合并",
      mergedProgress: (merged: number, total: number, failed: number) =>
        `已汇聚 ${merged}/${total} 个结果${failed > 0 ? ` · ${failed} 个失败` : ""}`,
      selectTask: "选择外围 Agent 查看任务详情",
    },
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作 AstraFlow。",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 AstraFlow 的界面和行为。",
    sections: {
      account: "账号",
      appearance: "外观",
      channels: "渠道",
    ...
    memory: {
      title: "记忆",
      description:
        "AstraFlow 会在后台不断从你的对话中自动学习。这些记忆能帮助 AstraFlow 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
    ...
    channels: {
      title: "渠道",
      description: "连接可在浏览器外向 AstraFlow 发送消息的即时通讯账号。",
      disabled:
    ...
    integrations: {
      ...
      lark: {
        ...
        authStarted: "授权页已打开，AstraFlow 会自动检测授权结果。",
        authorizationStillPending:
          "还没有检测到授权完成。请在浏览器完成授权；AstraFlow 会继续自动检测。如果页面没有更新，可点击“我已完成授权”。",
        ...
        openAuthLinkDescription:
          "打开下面的链接完成授权。AstraFlow 会持续自动检测，并在授权通过后保存连接状态。",
        waitingAuthTitle: "等待飞书授权完成",
        waitingAuthDescription:
          "请在刚打开的浏览器页面完成授权。AstraFlow 会自动更新这里的状态；下方按钮只是兜底操作。",
        openAuthLink: "打开链接",
        copyAuthLink: "复制链接",
        completeAuth: "我已完成授权",
        ...
        authNextDescription:
          "点击“连接飞书”后，AstraFlow 会先检查当前状态；未连接或授权过期时会拉起浏览器授权。",
      },
    },
    skills: {
      title: "技能",
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 AstraFlow 根目录下的 `/skills/custom` 文件夹中。",
    ...
    notification: {
      title: "通知",
      description:
        "AstraFlow 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "此账号通过 {provider} 登录，AstraFlow 无法在此管理或修改密码。请前往你的 SSO 提供商账号设置中进行操作。",
  ...
  login: {
    ...
    adminSetupRequiredDescription:
      "AstraFlow 需要先创建管理员账号，然后才能创建新的普通账号。",
