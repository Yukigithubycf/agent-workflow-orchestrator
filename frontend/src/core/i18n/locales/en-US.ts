...
export const enUS: Translations = {
  ...
  // Welcome
  welcome: {
    greeting: "What should we move forward today?",
    description: "The AstraFlow multi-agent orchestration workspace is ready.",

    createYourOwnSkill: "Design a new skill",
    createYourOwnSkillDescription:
      "Define the goal, inputs, and outputs, then add it to the AstraFlow toolkit.",
  },
  ...
  // Input Box
  inputBox: {
    placeholder: "How can I assist you in orchestrating this outcome?",
    disclaimer: "AstraFlow is AI and can make mistakes",
    createSkillPrompt:
    ...
    voiceInputStart:
      "Dictate with voice. AstraFlow receives only transcribed text; audio is handled by your browser or system speech service.",
    ...
    surpriseMe: "Explore",
    surpriseMePrompt:
      "Choose a worthwhile direction to explore and produce an actionable result.",
    ...
    suggestions: [
      {
        suggestion: "Design plan",
        prompt: "Create a clear, actionable plan for [topic]",
        icon: PenLineIcon,
      },
      {
      ...
      {
        suggestion: "Data insight",
        prompt:
          "Collect data from [source], identify trends, and create a report.",
        icon: ShapesIcon,
      },
      {
        suggestion: "Knowledge map",
        prompt: "Map the core concepts of [topic] and create a learning path.",
  ...
  taskExamples: {
    ...
    title: "Task examples",
    description:
      "Choose an example to fill the composer and switch to its recommended mode. You can edit it before sending.",
    onboardingTitle: "Not sure where to start?",
    onboardingDescription:
      "Open task examples to try a ready-made request with the right mode selected.",
    ...
    aiNewsPrompt: "Summarize five frontier AI news stories from the past week.",
    codingAgentsPrompt:
      "Research OpenAI Codex, Claude Code, and Gemini CLI. Compare their features, pricing, and suitability for teams, then recommend which one to choose.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. AstraFlow is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but AstraFlow could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "AstraFlow's official website",
    githubTooltip: "AstraFlow on GitHub",
    settingsAndMore: "Settings and more",
    visitGithub: "AstraFlow on GitHub",
    reportIssue: "Report an issue",
    contactUs: "Contact us",
    about: "About AstraFlow",
    logout: "Log out",
  ...
  channels: {
    ...
    descriptions: {
      telegram: "Telegram direct messages through your AstraFlow bot.",
      slack: "Slack workspace messages and mentions.",
      discord: "Discord server messages through your AstraFlow bot.",
      feishu: "Feishu and Lark messages through your AstraFlow app.",
      dingtalk: "DingTalk Stream Push messages through your AstraFlow bot.",
      wechat: "WeChat iLink messages through your AstraFlow bot.",
      wecom: "WeCom messages through your AstraFlow AI bot.",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to AstraFlow",
  ...
  subtasks: {
    ...
    galaxy: {
      ...
      dispatching: "Dispatching subagents",
      parallel: (count: number) =>
        `${count} subagent${count === 1 ? "" : "s"} working in parallel`,
      converging: "Merging subagent results",
      completed: "Subagent results merged",
      mergedProgress: (merged: number, total: number, failed: number) =>
        `${merged}/${total} results merged${failed > 0 ? ` · ${failed} failed` : ""}`,
      selectTask: "Select a subagent to inspect its work",
    },
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate AstraFlow faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how AstraFlow looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "AstraFlow automatically learns from your conversations in the background. These memories help AstraFlow understand you better and deliver a more personalized experience.",
    ...
    channels: {
      title: "Channels",
      description:
        "Connect IM accounts that can send messages to AstraFlow from outside the browser.",
      disabled:
    ...
    integrations: {
      ...
      lark: {
        ...
        authStarted:
          "Authorization page opened. AstraFlow will detect completion automatically.",
        authorizationStillPending:
          'Authorization is not complete yet. Finish it in the browser; AstraFlow keeps checking automatically. You can click "I completed authorization" if the page does not update.',
        permissionTitle: "Authorization scope",
        permissionDescription:
          "By default, AstraFlow only completes the base sign-in and does not request any business permissions. Select the domains you need here; connected users can re-authorize to add more (scopes accumulate).",
        authDomains: {
          calendar: {
            label: "Calendar",
            description:
        ...
        openAuthLinkDescription:
          "Open the link below to authorize. AstraFlow keeps checking automatically and will save the connection after approval.",
        waitingAuthTitle: "Waiting for Lark authorization",
        waitingAuthDescription:
          "Finish authorization in the browser page that just opened. AstraFlow will update this panel automatically; the button below is only a fallback.",
        ...
        authNextDescription:
          "Click “Connect Lark”; AstraFlow checks the current status first and opens browser authorization only when disconnected or expired.",
      },
    },
    skills: {
      title: "Agent Skills",
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of AstraFlow.",
    ...
    notification: {
      title: "Notification",
      description:
        "AstraFlow only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "This account signs in with {provider}, so AstraFlow cannot manage or change its password here. Use your SSO provider's account settings instead.",
  ...
  login: {
    ...
    rememberMeDescription:
      "Keep this browser session when possible. AstraFlow stores only your email, never your password.",
    ...
    adminSetupRequiredDescription:
      "AstraFlow needs an administrator account before new regular accounts can be created.",
