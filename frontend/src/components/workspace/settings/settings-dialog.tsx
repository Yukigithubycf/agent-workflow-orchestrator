...
import { BrainIcon, PaletteIcon, SparklesIcon, WrenchIcon } from "lucide-react";
...
export type SettingsSection = "appearance" | "memory" | "tools" | "skills";
...
export function SettingsDialog(props: SettingsDialogProps) {
  ...
  useEffect(() => {
    ...
    // This allows callers to open the dialog directly on a visible settings page.
    if (dialogProps.open) {
