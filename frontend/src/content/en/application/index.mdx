---
title: AstraFlow App
description: AstraFlow App is the reference implementation of what a production AstraFlow experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
---
...
<Callout type="info" emoji="🚀">
  AstraFlow App is a complete Super Agent application built on top of AstraFlow
...
AstraFlow App is the reference implementation of what a production AstraFlow experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
...
The AstraFlow App runs behind a single nginx reverse proxy:
...
| Agent runtime     | LangGraph, LangChain, AstraFlow Harness                               |
| Reverse proxy     | nginx                                                                |
