...
<Callout type="info" emoji="🔧">
  Tools are the actions the Lead Agent can take. AstraFlow provides built-in
...
AstraFlow organizes tools into four categories:
...
through AstraFlow's artifact system. This is useful for visual evidence, UI checks,
