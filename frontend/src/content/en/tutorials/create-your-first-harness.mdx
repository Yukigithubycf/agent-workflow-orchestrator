...
description: This tutorial shows you how to use the AstraFlow Harness programmatically — importing and using AstraFlow directly in your Python code rather than through the web interface.
---
...
This tutorial shows you how to use the AstraFlow Harness programmatically — importing and using AstraFlow directly in your Python code rather than through the web interface.

## Prerequisites

- Python 3.12+
- `uv` installed
- AstraFlow repository cloned
