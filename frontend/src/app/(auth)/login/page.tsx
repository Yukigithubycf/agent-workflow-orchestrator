...
export default function LoginPage() {
  ...
  return (
    <div className="bg-muted/30 relative flex min-h-screen items-center justify-center overflow-x-hidden overflow-y-auto p-4">
      <div className="bg-background w-full max-w-md space-y-6 rounded-lg border p-6 shadow-sm sm:p-8">
