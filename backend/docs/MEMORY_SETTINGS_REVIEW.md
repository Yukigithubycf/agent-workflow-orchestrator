...
1. Start AstraFlow locally using any working development setup you already use.
   ...
   If you already have AstraFlow running locally, you can reuse that existing setup.
