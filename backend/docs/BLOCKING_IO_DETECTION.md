...
This document describes how to use and maintain AstraFlow backend blocking-IO
...
Keeping rules centralized makes it clear which extra primitives AstraFlow
