...
Quick setup instructions for AstraFlow.

## Configuration Setup

AstraFlow uses a YAML configuration file that should be placed in the **project root directory**.
...
- **Runtime root**: Set `DEER_FLOW_PROJECT_ROOT` if AstraFlow may start from outside the project root
