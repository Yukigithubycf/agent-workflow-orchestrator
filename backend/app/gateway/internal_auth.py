...
INTERNAL_AUTH_HEADER_NAME = "X-AstraFlow-Internal-Token"
INTERNAL_OWNER_USER_ID_HEADER_NAME = "X-AstraFlow-Owner-User-Id"
...
def get_internal_user(owner_user_id: str | None = None):
    ...
    ``X-AstraFlow-Owner-User-Id`` header), the synthetic user's ``.id``
