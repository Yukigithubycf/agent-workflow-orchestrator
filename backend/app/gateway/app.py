...
async def _ensure_admin_user(app: FastAPI) -> None:
    ...
    "no-auth → with-auth" upgrade path: users who ran AstraFlow without
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        title="AstraFlow API Gateway",
        description="""
## AstraFlow API Gateway

API Gateway for AstraFlow - A LangGraph-based AI agent backend with sandbox execution capabilities.
...
This gateway provides runtime endpoints for agent runs plus custom endpoints for models, MCP configuration, skills, and artifacts.
        ...
        openapi_tags=[
            ...
            {
                "name": "threads",
                "description": "Manage AstraFlow thread-local filesystem data",
            },
            {
                "name": "agents",
