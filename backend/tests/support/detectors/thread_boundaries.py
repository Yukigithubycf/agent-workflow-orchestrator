...
EXACT_CALL_RULES: dict[str, _CallRule] = {
    ...
    "deerflow.utils.file_io.run_file_io": _CallRule(
        ...
        DEDICATED_EXECUTOR,
        "Offloads filesystem work into AstraFlow's dedicated file-IO executor.",
    ),
    ...
    "make_sync_tool_wrapper": _CallRule(
        ...
        "SYNC_TOOL_WRAPPER",
        DEDICATED_EXECUTOR,
        "Adapts an async tool for sync invocation through AstraFlow's dedicated tool executor.",
    ),
