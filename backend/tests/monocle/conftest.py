"""Fixtures for the AstraFlow Monocle behavioural tests.
...
def run_agent() -> Callable[[str], str]:
    ...
    Skips unless ``MONOCLE_LIVE_TESTS=1`` is set, when the AstraFlow app is not
    ...
    pytest.importorskip("deerflow", reason="AstraFlow app not importable in this venv")
