    ...
    if unexpected:
        findings.append(
            make_finding(
                ...
                remediation="Remove unsupported fields or add them to the shared AstraFlow frontmatter schema.",
                evidence=unexpected,
            )
        )
    ...
    if not isinstance(description, str) or not description.strip():
        ...
        findings.append(
            make_finding(
                ...
                severity="error",
                path="SKILL.md",
                message="Description exceeds AstraFlow's 1024 character limit.",
