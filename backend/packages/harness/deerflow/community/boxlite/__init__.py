"""BoxLite micro-VM backend for AstraFlow sandboxes.
...
macOS) — behind AstraFlow's :class:`Sandbox` / :class:`SandboxProvider` contract.
...
virtualization when AstraFlow itself runs inside a cloud VM); macOS uses
