...
that builds a AstraFlow graph (gateway, workers, in-process LangGraph
...
def _as_overwrite(value: Any) -> tuple[bool, Any]:
    ...
    AstraFlow's write paths produce for these Union channels (the branch and
    ...
    an internal serialization detail AstraFlow never emits into these channels.
    """
