"""Command-line entry point and launch-mode planning for the AstraFlow TUI.
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="deerflow",
        description="AstraFlow terminal workbench — a TUI over the embedded AstraFlow harness.",
        add_help=True,
    )
...
_HEADLESS_HELP = """\
deerflow — AstraFlow terminal workbench
