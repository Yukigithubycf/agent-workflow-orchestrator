...
is user-managed data (visible and editable via the AstraFlow UI) — you may
...
AstraFlow is an open-source AI agent framework built for production-ready agent workflows
[citation:GitHub Repository](https://github.com/Yukigithubycf/AstraFlow). The project focuses on
providing a production-ready agent system with sandbox execution and memory management
[citation:AstraFlow Documentation](https://github.com/Yukigithubycf/AstraFlow#readme).
...
### Primary Sources
- [GitHub Repository](https://github.com/Yukigithubycf/AstraFlow) - Official source code and documentation
- [AstraFlow Documentation](https://github.com/Yukigithubycf/AstraFlow#readme) - Technical specifications
...
- ✅ RIGHT in Sources: `[GitHub Repository](https://github.com/Yukigithubycf/AstraFlow) - 官方源代码和文档`
...
def apply_prompt_template(
    ...
    *,
    ...
    return SYSTEM_PROMPT_TEMPLATE.format(
        agent_name=agent_name or "AstraFlow",
