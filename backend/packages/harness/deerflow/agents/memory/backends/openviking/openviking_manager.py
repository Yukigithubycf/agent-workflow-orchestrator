...
memory search results back to AstraFlow's backend-neutral shapes.
"""
...
# ABC contract -- the only AstraFlow import in this backend package.
...
class OpenVikingMemoryManager(MemoryManager):
    ...
    def _identity(self, user_id: str | None, agent_name: str | None) -> OpenVikingIdentity:
        ...
        # AstraFlow scope also prevents raw emails/usernames from leaving the
