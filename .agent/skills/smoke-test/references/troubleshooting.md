...
This document lists common issues encountered during AstraFlow smoke testing and how to resolve them.
...
3. Or stop AstraFlow services first:
   ```bash
   make stop
   ```
...
#### Clean Up All AstraFlow-Related Containers and Images
```bash
make docker-stop
