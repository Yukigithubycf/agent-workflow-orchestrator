# AstraFlow Smoke Test Standard Operating Procedure (SOP)

This document describes the detailed operating steps for each phase of the AstraFlow smoke test.

## Phase 1: Code Update Check

### 1.1 Confirm Current Directory

**Objective**: Verify that the current working directory is the AstraFlow project root.
...
**Success Criteria**: All ports are free, or they are occupied only by AstraFlow-related processes.
...
**Success Criteria**: Port 2026 is free, or it is occupied only by a AstraFlow-related process.
